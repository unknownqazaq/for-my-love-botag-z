...
var Flowtime = (function () {
                  ...
                  if (b2 > bq) {
                    ...
                    if (b2 < bq) {
                      ...
                      if (b2 == bq) {
                        if (
                          p == true &&
                          (D.section > z.getPageIndex().section ||
                            D.page > z.getPageIndex().page)
                        ) {
                          for (var b3 = 0; b3 < b0.length; b3++) {
                            bn(b4, b2, b3);
                          }
  ...
  function aZ(a8) {
    if (a8.length > 0) {
      ...
      var ba =
        document.querySelector(aU + "[data-id=__" + e[0] + "]") ||
        document.querySelector(aU + "[data-prog=__" + e[0] + "]");
      if (ba != null) {
        var a9 = null;
        if (e.length > 1) {
          a9 =
            ba.querySelector(aK + "[data-id=__" + e[1] + "]") ||
            ba.querySelector(aK + "[data-prog=__" + e[1] + "]");
        }
        if (a9 == null) {
  ...
  function d(e) {
    return e.getAttribute("data-id") != null
      ? e.getAttribute("data-id").replace(/__/, "")
      : e.getAttribute("data-prog").replace(/__/, "");
  }
  ...
  function a3(a9) {
    ...
    if (Brav1Toolbox.testCSS("transform")) {
      if (C) {
        J.style[Brav1Toolbox.getPrefixed("transform")] =
          "translateX(" + -a8 + "px) translateY(" + -ba + "px)";
      } else {
        J.style[Brav1Toolbox.getPrefixed("transform")] =
          "translateX(" + -a8 * 100 + "%) translateY(" + -ba * 100 + "%)";
      }
    } else {
      if (C) {
        J.style.top = -ba + "px";
          ...
          for (var bg = 0; bg < ba.length; bg++) {
            ...
            if (bf != undefined) {
              for (var bc = 0; bc < bf.length; bc++) {
                ...
                if (ao) {
                  bh.style[Brav1Toolbox.getPrefixed("transform")] =
                    "translateX(" + a8 + "px) translateY(" + e + "px)";
                } else {
                  bh.style[Brav1Toolbox.getPrefixed("transform")] =
                    "translateX(" + a8 + "%) translateY(" + e + "%)";
                }
              }
            }
          }
  ...
  function changeImages() {
    const images = document.querySelectorAll("img"); // Получаем все изображения
    const newImageUrls = ["img/new1.jpg", "img/new2.jpg", "img/new3.jpg"]; // Новые URL изображений

    images.forEach((img, index) => {
      if (newImageUrls[index]) {
        img.src = newImageUrls[index]; // Меняем src на новый
        img.alt = "Новое изображение " + (index + 1); // Обновляем alt
      }
    });
  }
